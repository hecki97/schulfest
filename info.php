...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="metro">
    <header>
      <nav class="navigation-bar dark fixed-top">
        <nav class="navigation-bar-content">
          <a href="./index.php" class="element"><span class="icon-arrow-left-5"></span> <?=$string['links']['a.schulfest']; ?></a>
    ...
    <table>
      ...
      <tr><a href="https://github.com/hecki97/schulfest"><h2><?=$string['labels']['l.source.code']; ?></h2></a></tr><br/>
